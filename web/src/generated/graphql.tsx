...
export const UpdateProductDocument = gql`
    mutation UpdateProduct($id: Float!, $name: String!, $description: String!, $price: Float!, $imagePath: String!) {
  updateProduct(id: $id, name: $name, description: $description, price: $price, imagePath: $imagePath) {
    id
  }
}
    `;
